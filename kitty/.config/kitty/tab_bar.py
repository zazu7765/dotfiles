...
def get_battery_cells() -> list:
    try:
        percent = subprocess.call('''system_profiler SPPowerDataType | grep "Cycle Count" | awk '{print $5}''', shell=True)
        status = subprocess.call('''system_profiler SPPowerDataType | grep "Charging" | awk 'NR==1{print$2}''')
